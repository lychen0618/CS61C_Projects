...
class TestAbs(TestCase):
    ...
    def tearDownClass(cls):
        print_coverage("abs.s", verbose=True)
...
class TestClassify(TestCase):
    ...
    def test_mnist_input3(self):
        t = self.make_test()
        out_file = "outputs/test_basic_main/student3.bin"
        args = ["inputs/mnist/bin/m0.bin", "inputs/mnist/bin/m1.bin",
                "inputs/mnist/bin/inputs/mnist_input3.bin", out_file]
        t.input_scalar("a2", 0)
        # call classify function
        t.call("classify")
        # generate assembly and pass program arguments directly to venus
